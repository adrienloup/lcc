      ...
      >
        <article className='article'>
          ...
          <div className='frame'>
            ...
            <Text text={`<p>Cela représente ${materialsScore} tonnes de matières premières. Comme si chaque année, nous creusons pour extraire l’équivalent de ${desktopScore} ordinateurs portables et que chaque utilisateur creusait pour extraire l’équivalent de ${coinScore} pièces de 1&nbsp;€.</p>`} />
